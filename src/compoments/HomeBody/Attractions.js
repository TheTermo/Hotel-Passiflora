        ...
        <div className="attractions">
            ...
            <div className="attractionsCard">
                <div className="t-card">
                    ...
                    <h4>Śnieżka</h4>
                    <p>Śnieżka znacznie góruje nad otaczającymi ją grzbietami. Wznosi się w zachodniej części Czarnego Grzbietu. Na zachodzie Przełęcz pod Śnieżką oddziela ją od Równi pod Śnieżką</p>
                </div>
                <div className="t-card">
                    <div className="t-image">
                ...
                <div className="t-card">
                    ...
                    <p>Wózkiem może zjeżdżać jedna lub dwie osoby. Czas przejazdu trwa od 5 do 7 minut.
                        Tor nie posiada ograniczeń wiekowych, jednak dzieci do lat 8 muszą zjeżdżać z osobą pełnoletnią.</p>
                </div>
            </div>
        </div>
    )
